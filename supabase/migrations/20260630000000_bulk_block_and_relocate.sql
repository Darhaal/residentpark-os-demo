-- Title: Atomic Parking Bulk Block and Relocation
-- Path: supabase/migrations/20260630000000_bulk_block_and_relocate.sql
-- Functionality: Relocates or revokes affected assignments and blocks a zone/floor in one transaction.
...
REVOKE EXECUTE ON FUNCTION public.tx_bulk_block_and_relocate(text, text, text, text, uuid, jsonb)
  FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.tx_bulk_block_and_relocate(text, text, text, text, uuid, jsonb)
  TO authenticated;
